...
def integrand2d(s, t, sigma_lum, sigma_pot, dens_lum, mass, Mbh, rmin, beta, tensor):
    """
    This 2-dim integral is used when the Jeans integral is not analytic
    ...
    return nuv2los_integ*drdt*dr1dt
...
class jam_sph_proj:
    ...
    .. code-block:: python
        ...
        jam = jam_sph_proj(surf_lum, sigma_lum, surf_pot, sigma_pot, mbh,
            distance, rad, beta=None, epsrel=1e-2, errors=None, ml=None,
            normpsf=1, nrad=50, pixsize=0, plot=True, quiet=False, data=None,
            sigmapsf=0, step=0, tensor='los', scale=None)
    ...
    def __init__(self, surf_lum, sigma_lum, surf_pot, sigma_pot, mbh, distance,
                 rad, beta=None, epsrel=1e-2, errors=None, ml=None, normpsf=1,
                 nrad=50, pixsize=0, plot=True, quiet=False, data=None,
                 sigmapsf=0, step=0, tensor='los', scale=None):
        ...
        model, psfConvolution = second_moment(rad*pc, sigma_lum_pc,
            sigma_pot_pc, dens_lum, mass, mbh, beta, tensor, scale, sigmaPsf,
