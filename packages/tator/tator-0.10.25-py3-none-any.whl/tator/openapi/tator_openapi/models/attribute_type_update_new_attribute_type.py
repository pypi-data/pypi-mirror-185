...
class AttributeTypeUpdateNewAttributeType(object):
    ...
    def __init__(self, autocomplete=None, choices=None, default=None, description=None, dtype=None, labels=None, maximum=None, minimum=None, name=None, order=None, required=None, size=None, style=None, use_current=None, local_vars_configuration=None):  # noqa: E501
    ...
    def size(self):
        ...
        :return: The size of this AttributeTypeUpdateNewAttributeType. 
        :rtype: int
        """
        return self._size
    ...
    def size(self, size):
        ...
        :param size: The size of this AttributeTypeUpdateNewAttributeType.
        :type: int
        """
