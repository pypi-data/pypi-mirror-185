...
class AttributeType(object):
    ...
    def __init__(self, autocomplete=None, choices=None, default=None, description='', dtype=None, labels=None, maximum=None, minimum=None, name=None, order=0, required=False, size=None, style=None, use_current=None, local_vars_configuration=None):  # noqa: E501
