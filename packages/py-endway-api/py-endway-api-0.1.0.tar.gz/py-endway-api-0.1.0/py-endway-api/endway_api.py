...
class EndWayApi:
    ...
    def get_token(self) -> str:
        ...
        :rtype: str
        """
        response = self.session.get("https://endway.su/", cookies=self.cookies).text
        soup = BeautifulSoup(response, "html.parser")
        csrf = soup.find("html").get("data-csrf")
        return csrf

    def post_thread(self, section_id: int, title: str, message: str) -> dict:
        """
        Creating a post
    ...
    def member_post(self, member_id: int or str, message: str) -> dict:
        """
        ...
        response = self.session.post(url, cookies=self.cookies, data=data).json()
        return response

    def add_comment(self, post_id: int, message: str) -> dict:
        """
    ...
    def account_details(self, short_link: str = None, location: str = None, website: str = None,
                        ...
                        steam: str = None, discord: str = None, github: str = None) -> dict:
        data = {
            "_xfToken": self.xfToken,
            "short_link": short_link,
            "profile[location]": location,
            "profile[website]": website,
            "custom_fields[profilebackground]": profilebackground,
            "about_html": about_html,
            "custom_fields[telegram]": telegram,
            "custom_fields[vk]": vk,
            "custom_fields[Steam]": steam,
            "custom_fields[discord]": discord,
            "custom_fields[github]": github,
            "_xfResponseType": "json"
        }
    ...
    def security(self, old_password: str, new_password: str) -> dict:
        """
    ...
    def signature(self, signature_html: str) -> dict:
        """
