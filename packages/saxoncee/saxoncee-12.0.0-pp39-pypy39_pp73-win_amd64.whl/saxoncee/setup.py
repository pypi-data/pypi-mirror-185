...
if system() == 'Darwin':
    ...
    extra_link_args.append('libs\\win\\libsaxon-eec-12.0.lib')
else:
...
ext_modules = [Extension(
                       ...
                       libraries=['libs\\win\\saxon-eec-12.0']
                        ),
...
setup(
    name='saxoncee',
    version='12.0.0',
    description='A python package for the SaxonC-EE 12.0, an XSLT 3.0, XQuery 3.1, XPath 3.1 and Schema Validator processor by Saxonica.',
    long_description=long_description,
    long_description_content_type='text/markdown',
    author='ONeil Delpratt',
    author_email='oneil@saxonica.com',
    include_package_data=True,
    url='https://www.saxonica.com/download/c.xml',
