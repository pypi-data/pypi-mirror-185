...
class Browser:
    ...
    def evaluate_javascript(self, selector: typing.Optional[str] = None, *function: str, arg: typing.Optional[typing.Any] = None, all_elements: bool = False): ...
    ...
    def get_style(self, selector: str, key: str = 'ALL', assertion_operator: typing.Optional[assertionengine.assertion_engine.AssertionOperator] = None, assertion_expected: typing.Optional[typing.Any] = None, message: typing.Optional[str] = None): ...
