...
from ..classify_area_rain import classify_area_rain


def main():

    parser = argparse.ArgumentParser(prog='ClassifyAreaRain',
    ...
    classify_area_rain(buildings_path, t10_path, t25_path, t100_path, print_percent)
