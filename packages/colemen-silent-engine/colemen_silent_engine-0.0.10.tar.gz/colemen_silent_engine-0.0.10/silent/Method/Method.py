...
class Method(_eb.EntityBase):
    ...
    def __init__(self,main:config._main_type,package:config._package_type,name:str,pyclass:config._py_class_type=None,module:config._py_module_type=None,
                ...
                is_setter:bool=False,is_class_method:bool=False,tags:Union[str,list]=None,prop:config._py_property_type=None):
        '''
    ...
    def get_arg(self,name:str)->Iterable[config._method_argument_type]:
        for arg in self.arg_list:
    ...
    #         ----------
    #         `@author`: Colemen Atwood
    #         `@created`: 01-09-2023 16:42:16
    #         `@memberOf`: PostArg
    #         `@property`: return_type
    #     '''
    #     value = self._return_type
    #     typ = config.contains_typing_type(value)
    #     if typ is not False:
