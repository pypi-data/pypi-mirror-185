'''
Contains Text Color and Background Color
'''
...
class Colored:
    ...
    @staticmethod
    def text( text:str, color:Colors):
        r, g, b = color
        return "\033[38;2;{};{};{}m{}\033[0;0m".format(r, g, b, text)
    
    @staticmethod
    def raw_text( color:Colors):
        r, g, b = color
        return "\033[38;2;{};{};{}m".format(r, g, b)
    
    @staticmethod
    def background( text:str, color:Colors):
        r, g, b = color
        return "\033[48;2;{};{};{}m{}\033[0;0m".format(r, g, b, text)
    
    @staticmethod
    def console( text:str, fg_color:Colors, bg_color:Colors):
        #fresult = Colored.text( text, fg_color)
        #bresult = Colored.background( text, bg_color)
        return Colored.background( Colored.text( text, fg_color), bg_color)
