...
def randomize_transform(
        ...
        *,
        ...
        Union[bpy.types.bpy_prop_array[float], typing.Sequence[float], typing.
              Tuple[float, float, float], 'mathutils.Vector'] = (1.0, 1.0,
                                                                 1.0)):
    ...
    :type scale: typing.Union[bpy.types.bpy_prop_array[float], typing.Sequence[float], typing.Tuple[float, float, float], 'mathutils.Vector']
    '''
