...
def BoolProperty(name: str = "",
                 ...
                 get: typing.Any = None,
                 set: typing.Any = None) -> 'bpy.types.BoolProperty':
...
def EnumProperty(
        ...
        update: typing.Any = None,
        get: typing.Any = None,
        set: typing.Any = None) -> 'bpy.types.EnumProperty':
...
def FloatProperty(name: str = "",
                  ...
                  update: typing.Any = None,
                  get: typing.Any = None,
                  set: typing.Any = None) -> 'bpy.types.FloatProperty':
...
def IntProperty(name: str = "",
                ...
                update: typing.Any = None,
                get: typing.Any = None,
                set: typing.Any = None) -> 'bpy.types.IntProperty':
...
def PointerProperty(type: typing.Any = None,
                    name: str = "",
                    description: str = "",
                    options: typing.Set = {'ANIMATABLE'},
                    override: typing.Set = 'set()',
                    ...
                    update: typing.Any = None) -> 'bpy.types.PointerProperty':
