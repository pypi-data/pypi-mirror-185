...
def export_layout(override_context: typing.
                  ...
                  *,
                  ...
                  size: typing.Union[bpy.types.bpy_prop_array[int], typing.
                                     Sequence[int]] = (1024, 1024),
                  opacity: float = 0.25,
    ...
    :type size: typing.Union[bpy.types.bpy_prop_array[int], typing.Sequence[int]]
...
def randomize_uv_transform(
        ...
        *,
        ...
        scale: typing.
        Union[bpy.types.bpy_prop_array[float], typing.Sequence[float], typing.
    ...
    :type scale: typing.Union[bpy.types.bpy_prop_array[float], typing.Sequence[float], typing.Tuple[float, float], 'mathutils.Vector']
    '''
...
def stitch(override_context: typing.Union[typing.
           ...
           *,
           ...
           objects_selection_count: typing.
           Union[bpy.types.bpy_prop_array[int], typing.Sequence[int]] = (0, 0,
                                                                         0, 0,
                                                                         0,
                                                                         0)):
    ...
    :type objects_selection_count: typing.Union[bpy.types.bpy_prop_array[int], typing.Sequence[int]]
    '''
