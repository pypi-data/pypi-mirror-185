...
def clipboard_paste(
    ...
    :type offset: typing.Union[bpy.types.bpy_prop_array[float], typing.Sequence[float], typing.Tuple[float, float], 'mathutils.Vector']
    '''
...
def link(override_context: typing.Union[typing.
    ...
    :type drag_start: typing.Union[bpy.types.bpy_prop_array[float], typing.Sequence[float], typing.Tuple[float, float], 'mathutils.Vector']
...
def select(override_context: typing.Union[typing.
           ...
           *,
           ...
           location: typing.Union[bpy.types.bpy_prop_array[int], typing.
                                  Sequence[int]] = (0, 0),
    ...
    :type location: typing.Union[bpy.types.bpy_prop_array[int], typing.Sequence[int]]
