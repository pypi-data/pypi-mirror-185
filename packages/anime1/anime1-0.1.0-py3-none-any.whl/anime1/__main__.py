        ...
        if "://" in current_state:
            ...
            if current_state.split("://", 1)[1].replace("anime1.me/","").isdigit(): # https://anime1.me/17173
                ...
                with requests.Session() as s:
                    ...
                    print('mpv --demuxer-lavf-o=headers="Cookie: {}" --cookies --cookies-file="{}" {}'.format(parseCookieFile(cookiesFile), cookiesFile, video_url))
                    print(parseCookieFile(cookiesFile))
                    os.system('mpv --demuxer-lavf-o=headers="Cookie: {}" --cookies --cookies-file="{}" {}'.format(parseCookieFile(cookiesFile), cookiesFile, video_url))
                    sys.exit()
