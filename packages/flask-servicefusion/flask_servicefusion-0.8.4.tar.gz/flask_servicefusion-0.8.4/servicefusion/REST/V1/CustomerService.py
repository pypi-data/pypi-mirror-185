from servicefusion.REST.V1.mixins import CreateMixin, DeleteMixin

class CustomerService(CreateMixin, DeleteMixin):
    api_url = "customers"
    ...
    def get_customer_by_id(self, customer_id):
        ...
        return self._get(f'{self.api_url}/{customer_id}', params=params)
