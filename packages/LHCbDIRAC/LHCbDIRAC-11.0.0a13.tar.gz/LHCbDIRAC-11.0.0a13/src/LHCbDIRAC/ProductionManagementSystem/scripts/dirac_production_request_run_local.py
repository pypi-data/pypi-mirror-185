...
def parseArgs():
    ...
    return Path(yaml_path), name, eventType, numEvents, inputFiles, useCfgOverride
...
@Script()
def main():
    yamlPath, name, eventType, numEvents, inputFiles, useCfgOverride = parseArgs()
    ...
    testProductionRequest(productionRequest, eventType=eventType, numEvents=numEvents, inputFiles=inputFiles)
