...
class Engine:
    ...
    def __init__(self, config: ConfigGame):
        ...
        self.screen_res = config.screen_resolution
        ...
        self.background_color = pg.Color(config.background_color)
            ...
            for face_idx, face_info in enumerate(obj.list_face_info):
                ...
                if Engine.AreAllVertsVisible(list_polygon_vertex, self.screen_res_half.x, self.screen_res_half.y):
                    ...
                    if dp < 0.0:
                        ...
                        pg.draw.polygon(self.screen, face_color, list_polygon_vertex, 0)  
                        pg.draw.line(self.screen, pg.Color('white'), v0, v1, 2)
                        pg.draw.line(self.screen, pg.Color('white'), v1, v2, 2)
                        pg.draw.line(self.screen, pg.Color('white'), v2, v0, 2)
