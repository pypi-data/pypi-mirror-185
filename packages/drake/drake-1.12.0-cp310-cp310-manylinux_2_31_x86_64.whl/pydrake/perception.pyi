...
class DepthImageToPointCloud(pydrake.systems.framework.LeafSystem_[float]):
    ...
    def camera_pose_input_port(self) -> pydrake.systems.framework.InputPort_[float]: ...
    ...
    def point_cloud_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
...
class PointCloudToLcm(pydrake.systems.framework.LeafSystem_[float]):
