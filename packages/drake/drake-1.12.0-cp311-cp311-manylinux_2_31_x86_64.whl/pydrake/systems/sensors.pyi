...
class ImageToLcmImageArrayT(pydrake.systems.framework.LeafSystem_[float]):
    ...
    def DeclareImageInputPort[PixelType.kDepth16U](self, *args, **kwargs) -> Any: ...
    def DeclareImageInputPort[PixelType.kDepth32F](self, *args, **kwargs) -> Any: ...
    def DeclareImageInputPort[PixelType.kLabel16I](self, *args, **kwargs) -> Any: ...
    def DeclareImageInputPort[PixelType.kRgba8U](self, *args, **kwargs) -> Any: ...
    def color_image_input_port(self) -> pydrake.systems.framework.InputPort_[float]: ...
    def depth_image_input_port(self) -> pydrake.systems.framework.InputPort_[float]: ...
    def image_array_t_msg_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
    def label_image_input_port(self) -> pydrake.systems.framework.InputPort_[float]: ...

class ImageTraits[PixelType.kDepth16U]:
    class ChannelType(numpy.unsignedinteger):
        @classmethod
        def __init__(cls, *args, **kwargs) -> None: ...
        @overload
...
class ImageTraits[PixelType.kDepth32F]:
    class ChannelType(numpy.floating):
        @classmethod
        def __init__(cls, *args, **kwargs) -> None: ...
        @overload
...
class ImageTraits[PixelType.kLabel16I]:
    class ChannelType(numpy.signedinteger):
        @classmethod
        def __init__(cls, *args, **kwargs) -> None: ...
        @overload
...
class ImageTraits[PixelType.kRgba8U]:
    class ChannelType(numpy.unsignedinteger):
        @classmethod
        def __init__(cls, *args, **kwargs) -> None: ...
        @overload
...
class Image[PixelType.kDepth16U]:
    class Traits:
        class ChannelType(numpy.unsignedinteger):
            @classmethod
            def __init__(cls, *args, **kwargs) -> None: ...
...
class Image[PixelType.kDepth32F]:
    class Traits:
        class ChannelType(numpy.floating):
            @classmethod
            def __init__(cls, *args, **kwargs) -> None: ...
...
class Image[PixelType.kLabel16I]:
    class Traits:
        class ChannelType(numpy.signedinteger):
            @classmethod
            def __init__(cls, *args, **kwargs) -> None: ...
...
class LcmImageArrayToImages(pydrake.systems.framework.LeafSystem_[float]):
    def __init__(self) -> None: ...
    def color_image_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
    def depth_image_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
    def image_array_t_input_port(self) -> pydrake.systems.framework.InputPort_[float]: ...
...
class RgbdSensor(pydrake.systems.framework.LeafSystem_[float]):
    @overload
    def __init__(self, parent_id: pydrake.geometry.FrameId, X_PB: pydrake.math.RigidTransform_[float], color_camera: pydrake.geometry.render.ColorRenderCamera, depth_camera: pydrake.geometry.render.DepthRenderCamera) -> None: ...
    @overload
    def __init__(self, parent_id: pydrake.geometry.FrameId, X_PB: pydrake.math.RigidTransform_[float], depth_camera: pydrake.geometry.render.DepthRenderCamera, show_window: bool = ...) -> None: ...
    def X_BC(self) -> pydrake.math.RigidTransform_[float]: ...
    def X_BD(self) -> pydrake.math.RigidTransform_[float]: ...
    def body_pose_in_world_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
    def color_camera_info(self, *args, **kwargs) -> Any: ...
    def color_image_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
    def depth_camera_info(self, *args, **kwargs) -> Any: ...
    def depth_image_16U_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
    def depth_image_32F_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
    def label_image_output_port(self) -> pydrake.systems.framework.OutputPort_[float]: ...
...
class RgbdSensorDiscrete(pydrake.systems.framework.Diagram_[float]):
...
class _TemporaryName_N5drake5ValueINS_7systems7sensors5ImageILNS2_9PixelTypeE2EEEEE(pydrake.common.value.AbstractValue):
    ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: Image[PixelType.kRgba8U]) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> Image[PixelType.kRgba8U]: ...
    def get_value(self) -> Image[PixelType.kRgba8U]: ...
    def set_value(self, arg0: Image[PixelType.kRgba8U]) -> None: ...

class _TemporaryName_N5drake5ValueINS_7systems7sensors5ImageILNS2_9PixelTypeE5EEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: Image[PixelType.kDepth16U]) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> Image[PixelType.kDepth16U]: ...
    def get_value(self) -> Image[PixelType.kDepth16U]: ...
    def set_value(self, arg0: Image[PixelType.kDepth16U]) -> None: ...

class _TemporaryName_N5drake5ValueINS_7systems7sensors5ImageILNS2_9PixelTypeE6EEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: Image[PixelType.kDepth32F]) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> Image[PixelType.kDepth32F]: ...
    def get_value(self) -> Image[PixelType.kDepth32F]: ...
    def set_value(self, arg0: Image[PixelType.kDepth32F]) -> None: ...

class _TemporaryName_N5drake5ValueINS_7systems7sensors5ImageILNS2_9PixelTypeE7EEEEE(pydrake.common.value.AbstractValue):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: Image[PixelType.kLabel16I]) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> Image[PixelType.kLabel16I]: ...
    def get_value(self) -> Image[PixelType.kLabel16I]: ...
    def set_value(self, arg0: Image[PixelType.kLabel16I]) -> None: ...
...
def ApplyCameraConfig(config: CameraConfig, builder: pydrake.systems.framework.DiagramBuilder_[float], lcm_buses: pydrake.systems.lcm.LcmBuses = ..., plant = ..., scene_graph: pydrake.geometry.SceneGraph_[float] = ..., lcm: pydrake.lcm.DrakeLcmInterface = ...) -> None: ...
