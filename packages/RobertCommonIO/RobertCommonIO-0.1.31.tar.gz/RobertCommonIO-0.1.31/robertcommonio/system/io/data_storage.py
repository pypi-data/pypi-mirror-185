...
class DataEngineFactory(object):
    ...
    @classmethod
    def get_data_engines(cls, accessor: Any, point_names: List[str], date_range: Optional[DateRange] = None) -> Dict:
        results = {}
...
class DataStorage(object):
    ...
    @classmethod
    def load_history_data(cls, accessor: Any, date_range: DateRange, point_names: List[str], need_dict: bool = True):
        ...
        for proj_id, engine in DataEngineFactory.get_data_engines(accessor, list(ds_item_dict.values()), date_range).items():
