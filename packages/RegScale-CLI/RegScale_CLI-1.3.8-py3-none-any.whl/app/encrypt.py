...
import base64 as V1R45,platform as MJ5112,os,sys
...
def AB53621(JT3828):
	...
	if TH4874!=a9531:B.error(a[37]+a[50]+a[50]+a[47]+a[50]+a[26]+a[0]+a[52]+a[72]+a[69]+a[0]+a[80]+a[65]+a[83]+a[83]+a[75]+a[69]+a[89]+a[83]+a[0]+a[68]+a[79]+a[0]+a[78]+a[79]+a[84]+a[0]+a[77]+a[65]+a[84]+a[67]+a[72]+a[14]+a[0]+a[48]+a[76]+a[69]+a[65]+a[83]+a[69]+a[0]+a[84]+a[82]+a[89]+a[0]+a[65]+a[71]+a[65]+a[73]+a[78]+a[14]);sys.exit(1)
	else:
		a9531=A7801(a9531)
...
def JH0847(CV3S412):
	...
	if JHG2152(UY_45558):
		...
		if LMK849(CV3S412)and CV3S412.endswith(F):
			...
			B.info(a[41]+a[46]+a[38]+a[47]+a[26]+a[0]+a[5]+a[83]+a[0]+a[72]+a[65]+a[83]+a[0]+a[66]+a[69]+a[69]+a[78]+a[0]+a[69]+a[78]+a[67]+a[82]+a[89]+a[80]+a[84]+a[69]+a[68]+a[0]+a[83]+a[85]+a[67]+a[67]+a[69]+a[83]+a[83]+a[70]+a[85]+a[76]+a[76]+a[89]+a[14],CV3S412)
		else:B.error(a[37]+a[50]+a[50]+a[47]+a[50]+a[26]+a[0]+CV3S412+a[0]+a[68]+a[79]+a[69]+a[83]+a[78]+a[7]+a[84]+a[0]+a[69]+a[88]+a[73]+a[83]+a[84]+a[12]+a[0]+a[79]+a[82]+a[0]+a[73]+a[83]+a[0]+a[65]+a[78]+a[0]+a[85]+a[78]+a[65]+a[67]+a[67]+a[69]+a[80]+a[84]+a[65]+a[66]+a[76]+a[69]+a[0]+a[70]+a[73]+a[76]+a[69]+a[0]+a[69]+a[88]+a[84]+a[69]+a[78]+a[83]+a[73]+a[79]+a[78]+a[1]);sys.exit(1)
...
def IOA21H98(KAB46228):
	...
	if JHG2152(PH6239):
		...
		if LMK849(KAB46228)and KAB46228.endswith(F):
			...
			UIAS9877=UOPGG23441.decrypt(JYT32446)
			with open(KAB46228,a[87]+a[66])as BAB98455:BAB98455.write(UIAS9877)
			B.info(a[41]+a[46]+a[38]+a[47]+a[26]+a[0]+KAB46228+a[0]+a[72]+a[65]+a[83]+a[0]+a[66]+a[69]+a[69]+a[78]+a[0]+a[68]+a[69]+a[67]+a[82]+a[89]+a[80]+a[84]+a[69]+a[68]+a[0]+a[83]+a[85]+a[67]+a[67]+a[69]+a[83]+a[83]+a[70]+a[85]+a[76]+a[76]+a[89]+a[14])
		else:B.error(a[37]+a[50]+a[50]+a[47]+a[50]+a[26]+a[0]+KAB46228+a[0]+a[68]+a[79]+a[69]+a[83]+a[78]+a[7]+a[84]+a[0]+a[69]+a[88]+a[73]+a[83]+a[84]+a[12]+a[0]+a[79]+a[82]+a[0]+a[73]+a[83]+a[0]+a[65]+a[78]+a[0]+a[85]+a[78]+a[65]+a[67]+a[67]+a[69]+a[80]+a[84]+a[65]+a[66]+a[76]+a[69]+a[0]+a[70]+a[73]+a[76]+a[69]+a[0]+a[69]+a[88]+a[84]+a[69]+a[78]+a[83]+a[73]+a[79]+a[78]+a[1]);sys.exit(1)
	else:B.error(a[48]+a[65]+a[83]+a[83]+a[75]+a[69]+a[89]+a[83]+a[0]+a[68]+a[79]+a[78]+a[7]+a[84]+a[0]+a[77]+a[65]+a[84]+a[67]+a[72]+a[1]);sys.exit(1)
def YO9322():
	YR6248=FB1107SX()
