...
class logger:
    def __init__(self, filename=None, max_lines=10000):
        if not filename:
            filename = Path(sys.argv[0]).stem + '.txt'
        ...
        log_file = logging.FileHandler(filename, mode='w', encoding='utf-8')
