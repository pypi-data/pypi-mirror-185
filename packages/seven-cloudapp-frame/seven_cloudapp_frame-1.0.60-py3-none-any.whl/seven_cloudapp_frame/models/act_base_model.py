...
@LastEditTime: 2023-01-12 09:29:59
...
class ActBaseModel():
    ...
    def add_act_info(self, app_id, act_name, act_type, theme_id, share_desc_json, rule_desc_json, close_word="抱歉，程序维护中", agreement_json=[], brand_json={}):
        """
        :description: 添加活动信息
        :param app_id: 应用标识
        :param act_name: 活动名称
