...
@LastEditTime: 2023-01-12 09:37:18
...
class AddActInfoHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        agreement_json = self.get_param("agreement_json", "")
        brand_json = self.get_param("brand_json", "")
        ...
        invoke_result_data = act_base_model.add_act_info(app_id, act_name, act_type, theme_id, share_desc_json, rule_desc_json, close_word, agreement_json, brand_json)
        if invoke_result_data.success == False:
            return self.response_json_error(invoke_result_data.error_code, invoke_result_data.error_message)
