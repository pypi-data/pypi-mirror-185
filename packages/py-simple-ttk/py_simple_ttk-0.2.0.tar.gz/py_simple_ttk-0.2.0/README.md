# py_simple_ttk 0.0.0<a name="mark0"></a>
...
> 	...
```
### src.py_simple_ttk.utils.utils.get_installed_packages<a name="mark205"></a>[^](#mark200)
...
> 	...
```
### src.py_simple_ttk.utils.utils.get_unix_timestamp<a name="mark206"></a>[^](#mark200)
...
> 	...
```
### src.py_simple_ttk.utils.utils.get_unix_timestring<a name="mark207"></a>[^](#mark200)
...
> 	...
```
### src.py_simple_ttk.utils.utils.get_user_home_folder<a name="mark208"></a>[^](#mark200)
...
> 	...
```
### src.py_simple_ttk.utils.utils.open_folder_in_explorer<a name="mark209"></a>[^](#mark200)
...
> 	...
```
### src.py_simple_ttk.utils.utils.sort_dict_by_keys<a name="mark210"></a>[^](#mark200)
...
> 	...
```
### src.py_simple_ttk.utils.utils.timer_decorator<a name="mark211"></a>[^](#mark200)
...
> 	...
```
## File Generators<a name="mark212"></a>[^](#mark199)

### src.py_simple_ttk.utils.HTML_Generator.HTML_Generator<a name="mark213"></a>[^](#mark212)
```py
class HTML_Generator(object):
	...
	def start_paragraph(self, text=''):
		...
```
### src.py_simple_ttk.utils.TXT_Generator.TXT_Generator<a name="mark214"></a>[^](#mark212)
```py
class TXT_Generator(object):
	...
	def save(self, path):
		...
```
### src.py_simple_ttk.utils.MD_Generator.MD_Generator<a name="mark215"></a>[^](#mark212)
```py
class MD_Generator(object):
	...
	def set_slogan(self, slogan):
		...
```
## History Mixin<a name="mark216"></a>[^](#mark199)

### src.py_simple_ttk.utils.History.HistoryMixin<a name="mark217"></a>[^](#mark216)
...
class HistoryMixin(object):
	...
	def undo(self):
		...
```
## Color Functions<a name="mark218"></a>[^](#mark199)

### src.py_simple_ttk.utils.color.reduce_255<a name="mark219"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.rgb_to_hex<a name="mark220"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.rgba_to_hex<a name="mark221"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.hex_to_rgb<a name="mark222"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.hex_to_rgba<a name="mark223"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.get_gradient<a name="mark224"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.rgb_to_scalar<a name="mark225"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.scalar_to_rgb<a name="mark226"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.linear_gradient<a name="mark227"></a>[^](#mark218)
...
> 	...
```
### src.py_simple_ttk.utils.color.get_rainbow<a name="mark228"></a>[^](#mark218)
...
> 	...
```
# MegaWidgets<a name="mark229"></a>[^](#mark0)

## Notes MegaWidget<a name="mark230"></a>[^](#mark229)

### src.py_simple_ttk.mega_widgets.notes.NotesTab<a name="mark231"></a>[^](#mark230)
```py
class NotesTab(Tab):
	...
	def start_new_note(self, title=None):
		...
```
## Conversation MegaWidget<a name="mark232"></a>[^](#mark229)

### src.py_simple_ttk.mega_widgets.chat.ConversationsTab<a name="mark233"></a>[^](#mark232)
```py
class ConversationsTab(Tab):
	...
	def start_new_conversation(self, title=None):
		...
```
## Profile Management<a name="mark234"></a>[^](#mark229)

### src.py_simple_ttk.utils.ProfilesSystem.ProfilesSystem<a name="mark235"></a>[^](#mark234)
```py
...
```
### src.py_simple_ttk.utils.ProfilesSystem.UserProfile<a name="mark236"></a>[^](#mark234)
...
class UserProfile(object):
	...
	def set_username(self, name: str) -> None:
		...
```
### src.py_simple_ttk.utils.ProfilesSystem.get_profiles_folder<a name="mark237"></a>[^](#mark236)
...
> 	...
```
### src.py_simple_ttk.utils.ProfilesSystem.get_profiles_list<a name="mark238"></a>[^](#mark236)
...
> 	...
```
# Changelog<a name="mark239"></a>[^](#mark0)

## 0.0.0<a name="mark240"></a>[^](#mark239)
