...
class ReturnLeaseRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["avoid_node_labels", b"avoid_node_labels", "cluster_id", b"cluster_id", "job_id", b"job_id", "job_run_attempted", b"job_run_attempted", "kubernetes_id", b"kubernetes_id", "reason", b"reason"]) -> None: ...
