...
class JobCancelRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["job_id", b"job_id", "job_ids", b"job_ids", "job_set_id", b"job_set_id", "queue", b"queue"]) -> None: ...
...
class JobSetCancelRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "job_set_id", b"job_set_id", "queue", b"queue"]) -> None: ...
