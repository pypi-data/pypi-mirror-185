...
class JobLeaseReturnedEvent(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created", b"created"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id", b"cluster_id", "created", b"created", "job_id", b"job_id", "job_set_id", b"job_set_id", "kubernetes_id", b"kubernetes_id", "pod_number", b"pod_number", "queue", b"queue", "reason", b"reason"]) -> None: ...
...
class JobCancellingEvent(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created", b"created"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created", b"created", "job_id", b"job_id", "job_set_id", b"job_set_id", "queue", b"queue", "requestor", b"requestor"]) -> None: ...
