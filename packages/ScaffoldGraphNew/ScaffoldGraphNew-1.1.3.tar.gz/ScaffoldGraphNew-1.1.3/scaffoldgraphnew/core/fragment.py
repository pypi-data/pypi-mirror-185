"""
scaffoldgraphnew.core.fragment
"""
import re
...
from scaffoldgraphnew.core.scaffold import Scaffold
...
class Fragmenter(ABC):
    ...
    scaffold ``scaffoldgraphnew.core.Scaffold`` as an argument
    ...
    scaffoldgraphnew.core.Scaffold objects.
...
class MurckoRingFragmenter(Fragmenter):
    ...
    See Also
    --------
    scaffoldgraphnew.core.fragment.MurckoRingSystemFragmenter
...
class MurckoRingSystemFragmenter(Fragmenter):
    ...
    See Also
    --------
    scaffoldgraphnew.core.fragment.MurckoRingFragmenter
...
def get_scaffold_frags(frag, hash_func=None):
    ...
    -------
    set
        A set of scaffoldgraphnew.core.Scaffold objects which are unique
