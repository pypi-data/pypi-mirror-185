"""
scaffoldgraphnew tests.analysis.test_representation
"""

from scaffoldgraphnew.analysis import calc_average_pairwise_similarity, get_over_represented_scaffold_classes
