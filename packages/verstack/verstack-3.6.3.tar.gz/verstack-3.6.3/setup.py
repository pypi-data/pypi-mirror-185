...
if not rtd_build_env:
    ...
    dependencies.append('tensorflow>=2.7.0,<=2.11.0')
    dependencies.append('keras>=2.7.0,<=2.11.0')
...
setup(
  ...
  download_url = 'https://github.com/DanilZherebtsov/verstack/archive/refs/tags/3.6.3.tar.gz',
