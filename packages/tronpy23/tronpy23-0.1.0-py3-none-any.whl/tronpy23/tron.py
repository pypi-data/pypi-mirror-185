...
from tronpy23 import keys
from tronpy23.contract import Contract, ShieldedTRC20, ContractMethod
from tronpy23.keys import PrivateKey
from tronpy23.providers import HTTPProvider
from tronpy23.abi import tron_abi
from tronpy23.defaults import conf_for_name
from tronpy23.exceptions import (
    BadSignature,
    BadKey,
    BadHash,
    BlockNotFound,
...
class Trx(object):
    ...
    def account_permission_update(self, owner: TAddress, perm: dict) -> "TransactionBuilder":
        ...
        :param owner:
        :param perm: Permission dict from :meth:`~tronpy23.Tron.get_account_permission`
        """
...
class Tron(object):
    ...
    :param provider: An :class:`~tronpy23.providers.HTTPProvider` object, can be configured to use private node
