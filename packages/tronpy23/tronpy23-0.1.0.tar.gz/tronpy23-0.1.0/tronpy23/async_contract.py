...
from tronpy23.contract import Contract, ContractMethod, ContractFunctions, ShieldedTRC20
...
class AsyncContractMethod(ContractMethod):
    async def call(self, *args, **kwargs) -> "tronpy23.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
        return await self.__call__(*args, **kwargs)

    async def __call__(self, *args, **kwargs) -> "tronpy23.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
...
class AsyncShieldedTRC20(ShieldedTRC20):
    ...
    ) -> "tronpy23.async_tron.AsyncTransactionBuilder":
