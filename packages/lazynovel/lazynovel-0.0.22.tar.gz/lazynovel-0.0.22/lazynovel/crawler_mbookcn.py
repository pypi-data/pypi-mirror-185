...
def get_page_template(
    ...
    :return:
    """
    url = 'https://admin.mbookcn.com/prod-api/v3/open/mng/page-template'
    headers = {
        "Accept": "application/json, text/plain, */*",
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh;q=0.8,zh-TW;q=0.7,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2",
...
def get_short_link(
    ...
    :return:
    """
    url = f'https://admin.mbookcn.com/prod-api/v3/open/mng/short-link?id={link_id}'
    headers = {
        "Accept": "application/json, text/plain, */*",
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh;q=0.8,zh-TW;q=0.7,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2",
...
def get_novel_info_list(
    ...
    :return:
    """
    url = f'https://admin.mbookcn.com/prod-api/v3/open/mng/novel/getNovelInfoList'
    params = {
        'currentPage': current_page,
        'pageSize': page_size,
        'title': title,
...
def get_novel_chapter_list(
    ...
    :return:
    """
    url = f'https://admin.mbookcn.com/prod-api/v3/open/mng/novel/getNovelChapterList'
    params = {
        'currentPage': current_page,
        'pageSize': page_size,
        'novelId': novel_id
