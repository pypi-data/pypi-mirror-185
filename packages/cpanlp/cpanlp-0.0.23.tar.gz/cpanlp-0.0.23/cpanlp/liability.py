import datetime
class Liability:
    def __init__(self, account="张三", credit=666, due_date="2025-01-01"):
    ...
    def add_liability(self,  account:str, credit: float, due_date:str):
            self.liabilities.append(Liability( account,credit, due_date))
...
class PonziScheme:
    ...
    def add_victim(self, victim:str):
