...
class Inventory(Asset):
    def __init__(self, account="什么材料",debit=0, date="",is_measurable=True,likely_economic_benefit=True,net_realizable_value=0):
        super().__init__(account, debit, date)
        self.is_measurable = is_measurable
        self.likely_economic_benefit = likely_economic_benefit
