...
class FixedAsset(Asset):
    def __init__(self, purchase_price, taxes, transportation_costs, installation_costs, professional_services_costs,debit=0,account="建筑",date="2021-05-20",location="beijing",life_span:int=10):
...
class Land(FixedAsset):
    def __init__(self, purchase_price, taxes, transportation_costs, installation_costs, professional_services_costs,debit=0,account="建筑",date="2021-05-20",location="beijing",life_span:int=10):
        super().__init__(purchase_price, taxes, transportation_costs, installation_costs,professional_services_costs,debit=0,account="建筑",date="2021-05-20",location="beijing",life_span=10)
        self.location = location
    def area(self):
        # method to calculate area of land
        pass
    ...
    def potential_use(self):
        # method to check potential use of land
        pass
    def potential_use(self):
        # method to check potential use of land
        pass
    ...
    def appreciation(self, current_market_value):
        return current_market_value - self.debit
    
    def is_leased(self):
        # method to check if the land is leased or rented to other parties
        pass
