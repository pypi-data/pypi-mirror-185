...
class Control:
    ...
    def transfer_control(self, new_owner:str):
        self.owner = new_owner
class Income:
    def __init__(self,income_list:list=[100,200,300], customer="张老板", date="2021-05-02"):
        ...
        self.non_cash_consideration :str=None
        self.financing_terms :str =None
