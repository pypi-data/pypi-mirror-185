...
class Income:
    def __init__(self,income_list=List[float], customer="", date="2025-01-01"):
        self.income_list = np.array(income_list)
...
class Sales:
    def __init__(self, customer:str,product:str, quantity:int, unit_price:float,date:str):
        self.customer=customer
...
if __name__ == '__main__':
    sales = Sales("张","apple",50,0.2,"20230101")
    income = sales.generate_income()
