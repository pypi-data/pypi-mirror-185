...
class Group(OperationGroup):
    ...
    # bkapi resource check_resource_version_exists
    check_resource_version_exists = bind_property(
        Operation,
        name="check_resource_version_exists",
        method="GET",
        path="/api/v1/apis/{api_name}/resource_versions/exists/",
    )
