...
class PredicateBase(
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-extensions.glue.PredicateBase",
):
    def __init__(
        self,
        *,
    ...
    def _bind_options(self, _scope: constructs.IConstruct) -> typing.Any:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PredicateBase._bind_options)
...
@jsii.data_type(
    jsii_type="cdk-extensions.glue.PredicateOptions",
    jsii_struct_bases=[aws_cdk.ResourceProps],
    name_mapping={
        "account": "account",
        "environment_from_arn": "environmentFromArn",
...
class PredicateOptions(aws_cdk.ResourceProps):
    def __init__(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PredicateOptions.__init__)
            check_type(argname="argument account", value=account, expected_type=type_hints["account"])
            check_type(argname="argument environment_from_arn", value=environment_from_arn, expected_type=type_hints["environment_from_arn"])
            check_type(argname="argument physical_name", value=physical_name, expected_type=type_hints["physical_name"])
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
    ...
    def __repr__(self) -> str:
        return "PredicateOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class CrawlerPredicate(
    PredicateBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-extensions.glue.CrawlerPredicate",
):
    def __init__(
        self,
        crawler: ICrawler,
        *,
        logical_operator: PredicateLogicalOperator,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrawlerPredicate.__init__)
            check_type(argname="argument crawler", value=crawler, expected_type=type_hints["crawler"])
        options = CrawlerPredicateOptions(
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrawlerPredicate.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(aws_cdk.aws_glue.CfnTrigger.ConditionProperty, jsii.invoke(self, "bind", [scope]))
...
@jsii.data_type(
    jsii_type="cdk-extensions.glue.CrawlerPredicateOptions",
    jsii_struct_bases=[PredicateOptions],
    name_mapping={
        "account": "account",
        "environment_from_arn": "environmentFromArn",
        "physical_name": "physicalName",
...
class CrawlerPredicateOptions(PredicateOptions):
    def __init__(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrawlerPredicateOptions.__init__)
            check_type(argname="argument account", value=account, expected_type=type_hints["account"])
            check_type(argname="argument environment_from_arn", value=environment_from_arn, expected_type=type_hints["environment_from_arn"])
            check_type(argname="argument physical_name", value=physical_name, expected_type=type_hints["physical_name"])
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
    ...
    def logical_operator(self) -> PredicateLogicalOperator:
        ...
        return typing.cast(PredicateLogicalOperator, result)
    ...
    def __repr__(self) -> str:
        return "CrawlerPredicateOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class JobPredicate(
    PredicateBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-extensions.glue.JobPredicate",
):
    def __init__(
        self,
        job: IJob,
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JobPredicate.__init__)
            check_type(argname="argument job", value=job, expected_type=type_hints["job"])
        options = JobPredicateOptions(
            logical_operator=logical_operator,
            state=state,
            account=account,
            environment_from_arn=environment_from_arn,
    ...
    def bind(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JobPredicate.bind)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(aws_cdk.aws_glue.CfnTrigger.ConditionProperty, jsii.invoke(self, "bind", [scope]))
...
@jsii.data_type(
    jsii_type="cdk-extensions.glue.JobPredicateOptions",
    jsii_struct_bases=[PredicateOptions],
    name_mapping={
        "account": "account",
        "environment_from_arn": "environmentFromArn",
...
class JobPredicateOptions(PredicateOptions):
    def __init__(
        self,
        *,
        account: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(JobPredicateOptions.__init__)
            check_type(argname="argument account", value=account, expected_type=type_hints["account"])
            check_type(argname="argument environment_from_arn", value=environment_from_arn, expected_type=type_hints["environment_from_arn"])
            check_type(argname="argument physical_name", value=physical_name, expected_type=type_hints["physical_name"])
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
    ...
    def __repr__(self) -> str:
        return "JobPredicateOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
