...
export class DispPolyline extends DispPoly {
    ...
    static setTargetEdgeTemplateId(
        disp: DispPolylineT,
        val: number
    ): void {
        disp.ti = val
    ...
    static center(disp): PointI {
        return PeekCanvasBounds.fromGeom(disp.g)
            .center()
    }
    ...
    static makeShapeContext(context: PeekCanvasShapePropsContext): void {
        ...
        context.addProp(new ShapeProp(
            ...
            (
                disp,
                valObj
            ) => DispPolyline.setStartEndType(disp, valObj.id),
            "Line Start Style",
        ...
        context.addProp(new ShapeProp(
            ...
            (
                disp,
                valObj
            ) => DispPolyline.setEndEndType(disp, valObj.id),
            "Line End Style",
            {options: lineEndOptions}
        ))
