...
class EufyLifeBLEDevice:
    ...
    def update_state_from_advertisement_data(self, advertisement_data: AdvertisementData) -> None:
        ...
        elif self._model_id == "eufy T9148":
            if len(data) == 19 and data[6] == 0xCF:
                self._handle_advertisement_weight_update_t9148(data[6:])


    def _handle_advertisement_weight_update_t9148(self, data: bytearray) -> None:
        weight_kg = ((data[4] << 8) | data[3]) / 100
        is_final = data[9] == 0x00

        self._set_state_and_fire_callbacks(EufyLifeBLEState(weight_kg, is_final, False))
    ...
    def _handle_weight_update_t9146_t9147(self, data: bytearray) -> None:
        ...
        self._set_state_and_fire_callbacks(EufyLifeBLEState(weight_kg, is_final, weight_limit_exceeded))

    def _handle_weight_update_t9148(self, data: bytearray) -> None:
    ...
    def _notification_handler(self, _sender: int, data: bytearray) -> None:
        ...
        if self._model_id == "eufy T9140":
            ...
            if len(data) == 16 and data[0] == 0xCF and data[2] == 0x00:
                self._handle_weight_update_t9148(data)
