...
def SelectFeatures(datax=scref, clustername='Cluster', methodname='wilcoxon', numbergenes=300, folderchange=3,
                   pvalue=0.1):
    if methodname == 'wilcoxon':
        ...
        markerlist = scm.CamelSwapline.enrichmentscoreBETA(dfpfcclus=datax.obs[clustername], df_dev=dfdev2,
                                                           fc=folderchange, pvalcutoff=pvalue, shortcut=True)
