...
def SpeciesTFgenePatterns(adata, fontsizeWeight=0.65, clusterlist=None,
    ...
    dfregscore=pd.DataFrame( swTF.X)
    dfregscore.index=swTF.obs.index
    dfregscore.columns=swTF.var.index
    dfregscore=dfregscore.join(swTF.obs["Cluster"],how="inner")
