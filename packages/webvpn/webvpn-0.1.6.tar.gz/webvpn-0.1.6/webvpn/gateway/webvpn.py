...
if TEST_MODE:
    ...
    if SERVER == 23:
        magic_path = "77726476706e69737468656265737421a1a70fce72612600305ada"
    elif SERVER == 24:
        magic_path = "77726476706e69737468656265737421a1a70fce72612600305add"
    else:
        magic_path = "0"

    TOKEN_URL = BASE_URL + f"/http-23381/{magic_path}/token"
    PUSH_URL = BASE_URL + f"/http-23381/{magic_path}/push"
    PULL_URL = BASE_URL + f"/http-23381/{magic_path}/pull"
    KEEP_ALIVE_URL = BASE_URL + f"/http-23381/{magic_path}/keep-alive"
