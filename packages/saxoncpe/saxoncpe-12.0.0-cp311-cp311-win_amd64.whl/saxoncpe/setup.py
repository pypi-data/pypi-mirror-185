...
if system() == 'Darwin':
    ...
    extra_link_args.append('libs\\win\\libsaxon-pec-12.0.lib')
else:
...
ext_modules = [Extension(
                       ...
                       libraries=['libs\\win\\saxon-pec-12.0']
                        ),
...
setup(
    name='saxoncpe',
    version='12.0.0',
    description='A python package for the SaxonC-PE 12.0, an XSLT 3.0, XQuery 3.1, XPath 3.1 and Schema Validator processor by Saxonica.',
