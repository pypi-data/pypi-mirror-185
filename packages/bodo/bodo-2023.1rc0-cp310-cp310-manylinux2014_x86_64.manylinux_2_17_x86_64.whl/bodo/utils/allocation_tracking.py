...
def get_allocation_stats():
    vlyds__njr = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa(
        ), get_allocation_stats_hstr()
    jfup__slzy, zdb__vaczz, gfd__dgih, tlxmi__qqlwm = 0, 0, 0, 0
    for boxga__iuom in vlyds__njr:
        jfup__slzy += boxga__iuom[0]
        zdb__vaczz += boxga__iuom[1]
        gfd__dgih += boxga__iuom[2]
        tlxmi__qqlwm += boxga__iuom[3]
    return jfup__slzy, zdb__vaczz, gfd__dgih, tlxmi__qqlwm
