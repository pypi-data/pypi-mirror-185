...
def get_allocation_stats():
    emrdu__qldc = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa(
        ), get_allocation_stats_hstr()
    kgd__cysfd, ugc__rvch, jwpw__epad, vgz__dpn = 0, 0, 0, 0
    for wwfn__gmi in emrdu__qldc:
        kgd__cysfd += wwfn__gmi[0]
        ugc__rvch += wwfn__gmi[1]
        jwpw__epad += wwfn__gmi[2]
        vgz__dpn += wwfn__gmi[3]
    return kgd__cysfd, ugc__rvch, jwpw__epad, vgz__dpn
