...
def get_allocation_stats():
    cnyzi__zzt = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa(
        ), get_allocation_stats_hstr()
    wtt__gaiee, mqe__uzu, rwl__cgzxf, yhoox__gtl = 0, 0, 0, 0
    for zqbyh__epqb in cnyzi__zzt:
        wtt__gaiee += zqbyh__epqb[0]
        mqe__uzu += zqbyh__epqb[1]
        rwl__cgzxf += zqbyh__epqb[2]
        yhoox__gtl += zqbyh__epqb[3]
    return wtt__gaiee, mqe__uzu, rwl__cgzxf, yhoox__gtl
