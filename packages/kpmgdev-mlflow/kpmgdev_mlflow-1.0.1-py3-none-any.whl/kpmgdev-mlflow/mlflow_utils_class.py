...
class MlFlowMainLogging:
    ...
    def log_artifacts_from_dict(artifacts_dict: dict):
        ...
        for key_i in artifacts_dict.keys():
            ...
            try:
                ...
                MlFlowMainLogging.log_object_as_artifact_BY_type(artifacts=artifacts_dict, key=key_i, dir_path=tmp_save_dir_path)
    ...
    @staticmethod
    def main_mlflow_models_doc(experiment_name: str, run_name: str, description: str=None, parameters_dict: dict=None, metrics_dict: dict=None
