...
"""
import archer.ArcherServerClient as ASC
import re
import requests
from SigningError import SigningError
...
class ArcherAuth:
  ...
  def __enter__(self) -> ASC.ArcherServerClient:
    self.login()
    return ASC.ArcherServerClient(self)
