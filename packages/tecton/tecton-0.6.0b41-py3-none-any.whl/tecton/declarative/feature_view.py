...
from tecton.declarative.base import FeaturesConfig
...
def source_to_pipeline_node(
    source: Union[BaseDataSource, FilteredSource, RequestSource, BaseFeatureDefinition, FeaturesConfig], input_name: str
):
...
def transformation_to_pipeline_node(
    ...
    params_to_sources: Dict[
        str, Union[BaseDataSource, FilteredSource, RequestSource, BaseFeatureDefinition, FeaturesConfig]
    ],
) -> PipelineNode:
    ...
    **Do not instantiate this class directly.** Use :class:`tecton.declarative.on_demand_feature_view` instead.
    ...
    def __init__(
        ...
        *,  # All arguments must be specified with keywords
        ...
        pipeline_function,
        owner: Optional[str],
        sources: List[Union[RequestSource, BaseFeatureDefinition, FeaturesConfig]],
        user_function,
    ):
        """
