...
class FeatureService(Fco):
    ...
    def _from_spec(cls, feature_service_spec: specs.FeatureServiceSpec, fco_container: FcoContainer):
        ...
        obj.feature_set_config = FeatureSetConfig._from_spec(feature_service_spec, fco_container)
        ...
        for feature_set_item in feature_service_spec.feature_set_items:
            ...
            elif isinstance(fv_spec, (specs.MaterializedFeatureViewSpec, specs.FeatureTableSpec)):
            ...
            obj.feature_set_config._definitions_and_configs = obj.feature_set_config._definitions_and_configs + inputs
