...
class FeatureService(Fco):
    ...
    def __init__(
        ...
        *,
        ...
        features: List[Union[FeaturesConfig, BaseFeatureDefinition]] = None,
...
def prepare_args(
    *,
    ...
    features: List[Union[FeaturesConfig, BaseFeatureDefinition]],
    ...
    for fv in features:
        ...
        if isinstance(fv, BaseFeatureDefinition):
