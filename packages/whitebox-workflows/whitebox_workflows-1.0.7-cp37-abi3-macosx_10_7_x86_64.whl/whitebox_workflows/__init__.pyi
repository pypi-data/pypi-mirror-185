...
class WbEnvironment():
	...
	def svm_classification(self, input_rasters: List[Raster], training_data: Vector, class_field_name: str, c_value: float = 50.0, kernel_gamma: float = 0.5, tolerance: float = 0.1, test_proportion: float = 0.2, create_output: bool = False) -> Optional[Raster]: ...

	def svm_regression(self, input_rasters: List[Raster], training_data: Vector, class_field_name: str, c_value: float = 50.0, epsilon_value: float = 10.0, kernel_gamma: float = 0.5, test_proportion: float = 0.2, create_output: bool = False) -> Optional[Raster]: ...
