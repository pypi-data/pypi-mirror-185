...
def run_compiler(compiler_type: str, upload_id: int):
    """
...
def compile_measures(upload_id: int, grid_type: Optional[str] = None):
    ...
    try:
        ...
        for grid_type in grid_types:
            run_compiler(grid_type, upload_id)
    except Exception:
