...
class GoogleOAuth2LoginHandler(tornado.web.RequestHandler,
    ...
    async def get(self):
        ...
        log.write_logs("4.", str(self.get_argument('code', False)), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')    
        ...
        log.write_logs("6.", str(user), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
        self.set_secure_cookie("user", str(user))

        log.write_logs("7.", str(self.current_user), "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
        self.redirect("/")
...
class Userform(BaseHandler, tornado.web.RequestHandler,
    ...
    async def get(self):
        ...
        log.write_logs("9.", "Authenticated!", "auth", f'{os.environ.get("ENVIRONMENT")}-logs')
