...
setup(
    ...
    long_description="""Project Page : [rod2ik/teX2svg](https://gitlab.com/rod2ik/tex2svg)
...
* For All newer Credits: Rodrigo Schwencke at [rod2ik/tex2svg](https://gitlab.com/rod2ik/tex2svg)
* 3 lines initially inspired by Ryan Marcus at [RyanMarcus/tex2svg](https://github.com/RyanMarcus)

Licences:

* Rodrigo Schwencke : [GPLv3+](https://opensource.org/licenses/GPL-3.0)""",
    license="GPLv3+",
    url="https://gitlab.com/rod2ik/tex2svg",
    classifiers=[
