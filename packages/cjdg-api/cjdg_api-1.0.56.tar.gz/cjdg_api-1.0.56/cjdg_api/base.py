...
class baseT:
    ...
    def request(self, api_name=None, method="GET", url=None, api_prefix="api/", safe=False, domain=False, convert=False, **kwargs):
        protocol = "https" if safe else "http"
        domain_name = "bms.chaojidaogou.com" if domain else "it.xxynet.com"
...
class baseApi:
    ...
    def request(self, api_name=None, method="GET", url=None, api_prefix="api/", safe=True, domain=False, convert=False, **kwargs):
        protocol = "https" if safe else "http"
