...
def _parse_feature(feature: Union[Feature, FeatureWrapper, str, Any]) -> str:
...
class ChalkAPIClientImpl(ChalkAPIClientProtocol):
    ...
    def compute_resolver_output(
        ...
        return load_dataset(
            uris=status.urls, version=DatasetVersion.COMPUTE_RESOLVER_OUTPUT_V1, features=[], executor=None
        )
