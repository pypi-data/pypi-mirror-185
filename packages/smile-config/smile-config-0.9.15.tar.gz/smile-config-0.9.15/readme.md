...
1.  [Install](#org6ba5a41)
2.  [Usage](#org5812616)
    1.  [Dataclass to command line options](#org6bc2973)
        1.  [Simple types](#orgfe86e57)
        2.  [Complex types](#orgf5ab83a)
        3.  [Nested dataclass](#org047458b)
    2.  [APIs](#org8d2c72a)
        1.  [Example](#org943134f)
