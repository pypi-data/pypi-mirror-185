...
1.  [Install](#org9c5dc02)
2.  [Usage](#org8e647df)
    1.  [Dataclass to command line options](#org5e06fb0)
        1.  [Simple types](#orge9cc16d)
        2.  [Complex types](#orga74c3f0)
        3.  [Nested dataclass](#org8d469b2)
    2.  [APIs](#org41c766e)
        1.  [Example](#orga7b1f5b)
