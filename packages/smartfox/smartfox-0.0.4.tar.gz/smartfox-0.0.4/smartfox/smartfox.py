...
class Smartfox():
    ...
    def updateValues(self, values:dict) -> bool:
        ...
        self.phase3.current.value=values.get("u5993-41")
        self.phase3.power.value=values.get("u6011-41")
        ...
        # Temperature
        self.bufferHot.value = values.get("u6176-41")
        self.bufferCold.value = values.get("u6182-41")
        self.warmWater.value = values.get("u6182-41")
