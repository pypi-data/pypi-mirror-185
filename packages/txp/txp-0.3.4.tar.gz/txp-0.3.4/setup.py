...
['ArmSDK',
 ...
 'txp.cloud.cloud_functions.compute_asset_total_worked_time',
...
package_data = \
{'': ['*'],
 'txp.cloud.cloud_functions.compute_asset_total_worked_time': ['dist/*'],
...
{':extra == "cloud"': ['scipy>=1.4.0,<2.0.0'],
 ...
 ':extra == "dev"': ['google-auth>=2.2.1,<3.0.0',
