# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/utils/50_utils.convert.ipynb.

# %% auto 0
__all__ = ['convert_epoch_millisecond_to_datetime', 'convert_datetime_to_epoch_millisecond', 'convert_snake_to_pascal']

# %% ../../nbs/utils/50_utils.convert.ipynb 2
import datetime as dt

# %% ../../nbs/utils/50_utils.convert.ipynb 3
import fastcore.test as fctest

# %% ../../nbs/utils/50_utils.convert.ipynb 4
