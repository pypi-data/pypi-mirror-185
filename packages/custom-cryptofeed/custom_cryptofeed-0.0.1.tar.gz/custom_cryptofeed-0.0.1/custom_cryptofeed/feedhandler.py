...
'''
import asyncio
from custom_cryptofeed.connection import Connection
import logging
import signal
...
from custom_cryptofeed.defines import L2_BOOK
from custom_cryptofeed.feed import Feed
from custom_cryptofeed.log import get_logger
from custom_cryptofeed.nbbo import NBBO
from custom_cryptofeed.exchanges import EXCHANGE_MAP
...
class FeedHandler:
    ...
    def run(self, start_loop: bool = True, install_signal_handlers: bool = True, exception_handler=None):
        ...
        install_signal_handlers: bool, default True
            ...
            can only be done from the main thread's loop, so if running custom_cryptofeed on
