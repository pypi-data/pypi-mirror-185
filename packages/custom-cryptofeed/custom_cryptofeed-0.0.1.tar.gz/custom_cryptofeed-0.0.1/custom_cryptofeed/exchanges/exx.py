...
from custom_cryptofeed.defines import BID, ASK, BUY
from custom_cryptofeed.defines import EXX as EXX_id
from custom_cryptofeed.defines import L2_BOOK, SELL, TRADES
