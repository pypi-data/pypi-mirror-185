...
from custom_cryptofeed.connection import AsyncConnection, HTTPPoll, HTTPConcurrentPoll, RestEndpoint, Routes, WebsocketEndpoint
from custom_cryptofeed.defines import ASK, BALANCES, BID, BINANCE, BUY, CANDLES, FUNDING, FUTURES, L2_BOOK, LIMIT, LIQUIDATIONS, MARKET, OPEN_INTEREST, ORDER_INFO, PERPETUAL, SELL, SPOT, TICKER, TRADES, FILLED, UNFILLED
from custom_cryptofeed.feed import Feed
from custom_cryptofeed.symbols import Symbol
from custom_cryptofeed.exchanges.mixins.binance_rest import BinanceRestMixin
from custom_cryptofeed.types import Trade, Ticker, Candle, Liquidation, Funding, OrderBook, OrderInfo, Balance
...
class Binance(Feed, BinanceRestMixin):
    ...
    def __init__(self,api_base_url,websocket_base_url,depth_interval='100ms', **kwargs):
        """
        depth_interval: str
        ...
        self._reset()
        self.rest_endpoints = [RestEndpoint(api_base_url, routes=Routes('/api/v3/exchangeInfo', l2book='/api/v3/depth?symbol={}&limit={}', authentication='/api/v3/userDataStream'), sandbox='https://testnet.binance.vision')]
        self.websocket_endpoints = [WebsocketEndpoint(websocket_base_url, sandbox='wss://testnet.binance.vision')]
