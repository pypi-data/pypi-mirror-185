...
# verify value at runtime with custom_cryptofeed.types.COMPILED_WITH_ASSERTIONS
define_macros.append(('CYTHON_WITHOUT_ASSERTIONS', None))

extension = Extension("custom_cryptofeed.types", ["custom_cryptofeed/types.pyx"],
                    #   extra_compile_args=extra_compile_args,
                      define_macros=define_macros)

setup(
    name="custom_cryptofeed",
    ext_modules=cythonize([extension], language_level=3, force=True),
    version="0.0.1",
    author="Hooman Radmehr",
    author_email="dadmand.yas@gmail.com",
    ...
    install_requires=[
        ...
        # Two (optional) dependencies that speed up custom_cryptofeed:
