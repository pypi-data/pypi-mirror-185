...
import re
import os
from .text_reading import get_results_from_text,document_check
from .sleep_detection import detect_sleep
from .statistics import ExamStatistics
import pdf2image
from .image_reading import get_results_from_image, get_attributes,image_check
from .exceptions import ExamNotFoundException,InvalidFileTypeException
import PIL
import numpy as np
import pytesseract
import pandas as pd
