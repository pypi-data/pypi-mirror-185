...
def deprecate(
    ...
    *,
    ...
    - `parameter` (optional): The name of the parameter to deprecate. If none,
        the whole function is deprecated.
    - `default` (optional): Whether to deprecate the default value of the given parameter (`True`),
        or the use of the parameter itself (`False`, default).
    - `warn_at` (optional): Version or date at which to start emitting a deprecation warning to the user.
        The user will see a deprecation warning when executing the function.
    - `fail_at` (optional): Version or date at which to start raising a deprecation error.
    - `remove_at` (optional): Internal-use only. Version or date at which to remove the deprecated code
