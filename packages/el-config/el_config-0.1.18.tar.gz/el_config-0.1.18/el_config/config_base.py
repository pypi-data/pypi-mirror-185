...
class ConfigBase:
    ...
    def __init__(self, configs_dir: str=_CONFIGS_DIR, required_envs: list=[],
                        pre_load: callable=_PRE_LOAD, valid_schema: dict=None,
                        freeze: bool=True):
        ...
        Args:
            ...
            freeze        (bool,     optional): Freeze config
        """
    ...
    def _freeze_config(self):
        ...
        self.config = Box(self.config, frozen_box=self.freeze)
