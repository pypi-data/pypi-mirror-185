...
async def present(
    ...
    Args:
        ...
        resource_id(str, Optional): The name of the AWS CloudWatch Events Rule.
        ...
        rule_status (str, Optional): Indicates whether the rule is enabled or disabled.
        ...
        event_bus_name (str, Optional) : The name or ARN of the event bus to associate with this rule.
...
async def absent(
    ...
    Args:
        ctx:
        hub:
        resource_id(str): The name of the AWS CloudWatch Events Rule.
        name(str): A name, ID to identify the resource.
        event_bus_name (str, Optional) : The name or ARN of the event bus to associate with this rule.
            If you omit this, the default event bus is used.
