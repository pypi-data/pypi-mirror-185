...
class GanttCreatorMultiprocess(object):
    ...
    def __init__(self,
        ...
        self.frame_setting, self.video_setting, self.files_found, self.style_attr, self.cores = frame_setting, video_setting, files_found, style_attr, cores
        if (self.frame_setting != True) and (self.video_setting != True):
            print('SIMBA ERROR: Please choose either gantt videos, gantt frames, or both gantt frames and videos.')
            raise ValueError('SIMBA ERROR: Please choose either gantt videos, gantt frames, or both gantt frames and videos.')
