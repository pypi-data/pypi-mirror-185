...
#             animal_clr = style_attr['animal clrs']
#
#
#
#
...
#             self.style_attr['animal clrs'].append(tuple(x / 255 for x in color))
#
...
#               'max lines': 2000}
#
# animal_attr = {0: ['Ear_right_1', 'Red'], 1: ['Ear_right_2', 'Grey']}
# clf_attr = {0: ['Attack', 'Black', 'Size: 30'], 1: ['Sniffing', 'Red', 'Size: 30']}
#
# test = PathPlotterMulticore(config_path='/Users/simon/Desktop/envs/troubleshooting/two_black_animals_14bp/project_folder/project_config.ini',
#                    frame_setting=False,
#                    video_setting=True,
#                    last_frame=False,
