...
class GanttPlotPopUp(object):
    ...
    def __init__(self,
        ...
        gantt_multiprocess_cb.grid(row=2, column=0, sticky=W)
        self.multiprocess_dropdown.grid(row=2, column=1, sticky=W)
...
class VisualizeClassificationProbabilityPopUp(object):
    ...
    def __init__(self,
        ...
        probability_multiprocess_cb.grid(row=3, column=0, sticky=W)
