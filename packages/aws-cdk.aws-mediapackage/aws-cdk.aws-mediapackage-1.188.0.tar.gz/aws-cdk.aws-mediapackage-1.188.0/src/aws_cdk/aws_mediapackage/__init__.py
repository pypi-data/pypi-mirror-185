...
class CfnChannel(
    ...
    @builtins.property
    @jsii.member(jsii_name="attrHlsIngestingestEndpoints")
    def attr_hls_ingestingest_endpoints(self) -> _aws_cdk_core_f4b25747.IResolvable:
        '''
        :cloudformationAttribute: HlsIngest.ingestEndpoints
        '''
        return typing.cast(_aws_cdk_core_f4b25747.IResolvable, jsii.get(self, "attrHlsIngestingestEndpoints"))
