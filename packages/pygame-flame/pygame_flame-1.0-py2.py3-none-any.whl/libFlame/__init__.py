...
_red = [(8, 0, 0), (16, 0, 0), (32, 0, 0), (64, 0, 0), (128, 0, 0), (255, 0, 0), (255, 64, 0), (255, 128, 0), (255, 200, 0), (255, 255, 0)][::-1]
_blue = [(0, 0, 8), (0, 0, 16), (0, 0, 32), (0, 0, 64), (0, 0, 128), (0, 0, 255), (0, 64, 255), (0, 128, 255), (0, 200, 255), (0, 255, 255)][::-1]
_green = [(0, 8, 0), (0, 16, 0), (0, 32, 0), (0, 64, 0), (0, 128, 0), (0, 255, 0), (0, 255, 64), (0, 255, 128), (0, 255, 200), (0, 255, 255)][::-1]

class Flame:
	def __init__(self, size, pallete=_red, boxSize=8, randomSources=True, zeroOnIndexError=False):
