...
import humanize
import httpx
from . import config, logger, formats, errors
...
class Client:
    ...
    def _request(self, method, url_or_path, headers, retries=0, **kwargs):
        ...
        if retry_after_s := self._should_retry(method, status_code, response.headers, retries):
            ...
            return self._request(method, url, headers, retries+1, **kwargs)
