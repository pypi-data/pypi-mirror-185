...
class ImazuPacket(ABC):
    ...
    def make_change(self, value_type: ValueType, change_value: int) -> bytearray:
        """Change packet Make"""
        packet = self.make_base(Cmd.CHANGE, value_type)
...
class ThermostatPacket(ImazuPacket):
    ...
    def make_scan_mode(self) -> bytearray:
        """Scan packet Make"""
        return super().make_scan(ValueType.MODE)
...
class LightPacket(ImazuPacket):
    ...
    def make_scan_bool(self) -> bytearray:
        """Scan packet Make"""
        return super().make_scan(ValueType.BOOL)
...
class GasPacket(ImazuPacket):
    ...
    def make_scan_valve(self) -> bytearray:
        """Scan packet Make"""
        return super().make_scan(ValueType.VALVE)

    def make_change_valve_close(self) -> bytearray:
        """Valve close packet Make"""
        return super().make_change(ValueType.BOOL, int(str(GasPacket.Valve.CLOSE), 16))
...
class AwayModePacket(ImazuPacket):
    ...
    def make_change_valve(self, valve: Valve) -> bytearray:
        """Vavle packet Make"""
        return super().make_change(ValueType.BOOL, int(str(valve.value), 16))
...
class FanPacket(ImazuPacket):
    ...
    def make_change_power_off(self) -> bytearray:
        ...
        return super().make_change(ValueType.BOOL, int(str(FanPacket.Power.OFF.value), 16))
