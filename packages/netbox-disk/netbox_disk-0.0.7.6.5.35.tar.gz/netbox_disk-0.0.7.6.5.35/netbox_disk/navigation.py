...
physical_volume_menu_item = PluginMenuItem(
    link="plugins:netbox_disk:physical_volume_list",
    link_text="Physical Volume",
    permissions=["netbox_disk.disk_view"],
    buttons=(
        PluginMenuButton(
            "plugins:netbox_disk:physical_volume_add",
            "Add",
            "mdi mdi-plus-thick",
            ButtonColorChoices.GREEN,
            permissions=["netbox_disk.add_disk"],
        ...
        PluginMenuButton(
            "plugins:netbox_disk:physical_volume_import",
            "Import",
            "mdi mdi-upload",
            ButtonColorChoices.CYAN,
            permissions=["netbox_disk.add_disk"],
