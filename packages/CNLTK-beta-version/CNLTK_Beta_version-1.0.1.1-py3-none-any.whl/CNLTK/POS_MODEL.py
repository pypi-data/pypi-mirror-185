...
model = 'POS_TAG_WORD(1).h5'
vocab = 'vocab_model2.pkl'

with resources.open_binary('CNLTK', model) as mp:
    model = mp.read()
    
with resources.open_binary('CNLTK', vocab) as vp:
    vocab_model = vp.read()
...
# with open("vocab_model2.pkl", "rb") as f:
