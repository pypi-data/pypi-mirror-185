...
def NER_TAGGER_MODEL(test_samples):
    ...
    model2 = keras.models.load_model('CNLTK/models/NER_WORD(1).h5', custom_objects={'attention': attention, "CRF": CRF, 'crf_loss': crf_loss,'crf_viterbi_accuracy': crf_viterbi_accuracy}, compile=True)
