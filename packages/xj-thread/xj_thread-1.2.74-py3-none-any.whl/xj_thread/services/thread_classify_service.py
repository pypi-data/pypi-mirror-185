...
class ThreadClassifyService():
    ...
    def list(filter_fields_params=None, filter_fields=None, need_pagination=True):
        ...
        filter_fields_params = format_params_handle(
            ...
            filter_filed_list=["id", "category__value", "value", "name", "show", "show_id", "description", "category", "category_id", "icon", "sort", "parent_id", "config", ],
            alias_dict={"name": "name__contains", "category_value": "category__value"}
        )
        # 数据筛选
