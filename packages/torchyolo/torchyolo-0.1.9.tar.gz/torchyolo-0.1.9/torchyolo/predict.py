...
class YoloPredictor:
    ...
    def yolo_predictor(self, image, yaml_file=None):
        return self.model.predict(image, yaml_file=yaml_file)


if __name__ == "__main__":
    model = YoloPredictor(model_type="yolov8", model_path="yolov8n.pt", device="cpu", image_size=640)
    image = "data/highway.jpg"
    result = model.yolo_predictor(image)
