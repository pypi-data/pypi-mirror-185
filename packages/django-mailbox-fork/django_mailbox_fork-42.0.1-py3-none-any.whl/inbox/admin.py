...
"""
Model configuration in application ``inbox`` for administration
console.
"""
...
from inbox.models import MessageAttachment, Message, Mailbox
from inbox.signals import message_received
from inbox.utils import convert_header_to_unicode
