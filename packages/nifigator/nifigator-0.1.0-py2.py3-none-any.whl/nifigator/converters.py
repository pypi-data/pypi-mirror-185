...
from .nifobjects import NifContextCollection
from .nifobjects import NifContext
from .nifobjects import NifSentence
from .nifobjects import NifWord
from .nifobjects import NifParagraph
from .nifobjects import NifPage
from .nifobjects import NifPhrase

from .const import UD2OLIA_mappings, mapobject
...
def nafConverter(
    ...
    nif_context.set_Pages(
        page for page in nif_pages
    )
    ...
    for entity in nafdocument.entities:
        ...
        endIndex = int(words[entity_words[-1]]["offset"]) + int(
            words[entity_words[-1]]["length"]
        )
    ...
    nif_context.set_Paragraphs(
        paragraph["nif"] for paragraph in doc_paragraphs
    )
