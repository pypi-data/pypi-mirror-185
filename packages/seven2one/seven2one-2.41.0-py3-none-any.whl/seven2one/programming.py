...
class Programming():
    ...
    def createFunction(
        ...
        print("create fun: " + str(correlationId))
        with logger.contextualize(correlation_id=correlationId):
            ...
            if files == None: 
                ...
                self.commitFunctionFiles(functionId, files, correlationId=correlationId)
                ...
                if deploy == False:
                    ...
                    self.deployFunction(functionId, deploymentName, envVars, memoryLimit, cpuLimit, correlationId=correlationId)
                    return functionId
    ...
    def deleteFunction(self, functionId:str, force:bool=False) -> None:
        ...
        if confirm == 'y':
            result = Utils._executeGraphQL(self, graphQLString, correlationId)
            context_logger.info("Deleted function with result {}", result)
        else:
            return
        if result == None: return
