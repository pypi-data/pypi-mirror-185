...
def roof_predict(yolo_roof_model, folder):
    demoFolder = folder
    ############################################ input Image
    ...
    ############################################# Models
    last_roof_result = mask_prediction(yolo_roof_model, input_files, trainingDataset='Roof_boundary', output_folder=demoFolder,  cut_image = False, tile_len = 1984, tile_overlap = 1000)
