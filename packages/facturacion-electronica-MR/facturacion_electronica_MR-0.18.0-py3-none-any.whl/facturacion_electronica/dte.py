...
class DTE(object):
    ...
    @property
    def Emisor(self):
        if not hasattr(self, '_dte_emisor') or not self._dte_emisor:
    ...
    def _emisor(self):
        ...
        if self.es_boleta():
            ...
            if self.Emisor.GiroEmis:
                Emisor['GiroEmisor'] = self.Emisor.GiroEmisor
        else:
            Emisor['RznSoc'] = self.Emisor.RznSoc
            Emisor['GiroEmis'] = self.Emisor.GiroEmis
