...
class EtaB_ARS(ulysses.ULSBase):
    """
    BE for 2RHN with ARS leptogenesis. BEARS uses temperature independent rates. See version 2 of manual for complete equation description.
    """
...
class EtaB_ARS_INTERP(EtaB_ARS):
    """
    BE for 2RHN with ARS leptogenesis. BEARS uses temperature dependent rates. See versio\
n 2 of manual for complete equation description.
    """
