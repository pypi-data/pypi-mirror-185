...
#获取历史Greeks
print(api.getgreekshistory(GreeksType.GREEKS1K,"TC.F.U_SSE.510050.202212","2022121202"))
#获取ATM
        # -2:实值两档期权合约
        # -1:实值一档期权合约
        #  0:平值期权合约
...
# print(datetime.now()
#获取合约的greeks数据
print(api.getgreekshistory(GreeksType.DOGSK,"TC.O.SSE.510050.202301.C.2.5","2023010400","2023010407"))
