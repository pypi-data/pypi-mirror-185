...
def run_steps():
    ...
    while step <= 5:
        ...
        db.child("logs").push({"function_run_id": function_run_id, "message": message, "level": "info", "timestamp": datetime.datetime.utcnow().isoformat(), "status": "success"})
        ...
        if entered_step != str(step):
            if entered_step == 'exit':
                ...
                logging.info(message)
                db.child("logs").push({"function_run_id": function_run_id, "message": message, "level": "info", "timestamp": datetime.datetime.utcnow().isoformat(), "status": "error"})
        ...
        logging.info(message)
        b.child("logs").push({"function_run_id": function_run_id, "message": message, "level": "info", "timestamp": datetime.datetime.utcnow().isoformat(), "status": "success"})