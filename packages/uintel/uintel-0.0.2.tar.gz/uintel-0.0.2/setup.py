...
setuptools.setup(
    ...
    install_requires=['matplotlib', 'colour', 'slack_sdk', 'sqlalchemy', 'sqlalchemy_utils', 'psycopg2', 'pyyaml', 'tqdm', 'paramiko', 'boto3', 'geopandas', 'esridump', 'requests'],
    # State the files required for the package
    package_data={"ui": ["styles/*.mplstyle", "fonts/*.ttf"],},
)