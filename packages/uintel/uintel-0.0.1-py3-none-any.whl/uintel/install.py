...
def _install_styles(force: bool) -> None:
    ...
    try:
        ...
        if len(stylesheets) == 0:
            print(f"{_printColours.WARNING}No matplotlib stylesheets detected in this version. If you were expecting some to install, please contact the maintainer of this package, Sam.{_printColours.END}")
            return
        else:
