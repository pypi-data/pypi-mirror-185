import paramiko, os, tqdm, warnings, uintel as ui, zipfile, tempfile
...
class Server(object):
    ...
    def __init__(self) -> None:
        ...
        credentials = ui.config["SSH"].copy()
        try:
    ...
    def transfer_file(self, local_path: str, remote_path: str, show_progress=True) -> None:
        """
    ...
    def transfer_directory(self, local_directory: str, remote_directory: str, show_progress=True, zip_compression=zipfile.ZIP_DEFLATED) -> None:
        """
