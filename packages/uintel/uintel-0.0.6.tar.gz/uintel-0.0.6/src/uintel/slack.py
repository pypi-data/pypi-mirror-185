...
def post_message(where_to_post, message_type, identifier=None, message=None, greet=True, silent_usernames=None, emojis=False, domain="UI"):
    """
...
def post_files(where_to_post, filenames, message, greet=True, domain="UC"):
    """
