import tempfile, warnings, geopandas as gpd, numpy as np, pandas as pd, os, topojson as tp

def save_geodataframe_as_topojson(gdf, save_path, crs=2193, simplify_factor=None):
    """
