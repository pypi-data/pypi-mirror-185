...
def upload(df: pandas.DataFrame, table_name: str, db: dict, if_exists="replace") -> None:
    """
    Uploads a Pandas Dataframe to a SQL table called *table_name*. 
    Based on code from https://stackoverflow.com/a/47984180/5890574.
    """
