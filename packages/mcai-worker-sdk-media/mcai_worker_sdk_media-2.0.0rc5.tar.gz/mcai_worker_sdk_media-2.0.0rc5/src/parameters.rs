...
///
/// Warning:
///   You may take special care when defining this class to type properly its attributes.
///   Under the hoods, it will be used by the SDK to cast parameters arriving from the backend into their proper Python type.
#[pyclass(subclass)]
