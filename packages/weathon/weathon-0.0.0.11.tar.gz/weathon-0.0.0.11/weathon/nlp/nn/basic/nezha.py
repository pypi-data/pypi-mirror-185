...
from weathon.nlp.nn.configuration import NeZhaConfig
from weathon.nlp.nn.layer import NeZhaEncoder, NeZhaEmbeddings
...
class NeZhaPreTrainedModel(PreTrainedModel):
    ...
    load_tf_weights = TransformerUtils.load_tf_weights_in_nezha
