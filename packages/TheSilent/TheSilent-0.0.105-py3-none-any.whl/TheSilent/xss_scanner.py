...
def xss_scanner(url, secure = True, tor = False, my_file = " ",):
    ...
    #malicious script
    mal_payloads = ['<scipt>alert("TheSilent")</script>', 'toString(TheSilent)', 'TheSilent=TheSilent', 'getElementById(TheSilent)', "innerHTML=TheSilent", "src=TheSilent", 'console.log("TheSilent")', "document.write(TheSilent)", "window.print()", "appendChild(TheSilent)", "document.createTextNode(TheSilent)", "const a = TheSilent", "let b = TheSilent", "var c = TheSilent"]
