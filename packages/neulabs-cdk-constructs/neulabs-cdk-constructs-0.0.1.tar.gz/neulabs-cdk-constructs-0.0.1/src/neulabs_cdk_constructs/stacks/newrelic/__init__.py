...
class NewRelicStack(
    ...
    def create_firehose_stream(
        ...
        return typing.cast(_aws_cdk_aws_kinesisfirehose_ceddda9d.CfnDeliveryStream, jsii.invoke(self, "createFirehoseStream", [role, endpoint_type, endpoint_url, new_relic_license_ley]))
    ...
    @builtins.property
    @jsii.member(jsii_name="newRelicRole")
    def new_relic_role(self) -> _aws_cdk_aws_iam_ceddda9d.IRole:
        return typing.cast(_aws_cdk_aws_iam_ceddda9d.IRole, jsii.get(self, "newRelicRole"))

    @new_relic_role.setter
    def new_relic_role(self, value: _aws_cdk_aws_iam_ceddda9d.IRole) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f645a82ed78a8ff87c4cc381a94d84ee395b0514e054914ae8455e45230de07a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "newRelicRole", value)
...
def _typecheckingstub__f645a82ed78a8ff87c4cc381a94d84ee395b0514e054914ae8455e45230de07a(
    value: _aws_cdk_aws_iam_ceddda9d.IRole,
) -> None:
    """Type checking stubs"""
    pass
