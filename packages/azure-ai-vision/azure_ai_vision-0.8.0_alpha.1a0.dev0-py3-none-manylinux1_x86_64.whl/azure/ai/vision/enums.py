...
class ImageAnalysisOption(VisionOption):
    ...
    VISUAL_FEATURES = 1
    """
    A string property holding a list of visual feature to analyze. Multiple values should be comma-separated.
    ...
    GENDER_NEUTRAL_CAPTIONS = 5
    """
    Optional boolean property, set to \"yes\" or \"no\". If \"yes\", the words \"Man/Woman\" will be replaced by \"Person\",
    and \"Boy/Girl\" will be replaced by \"Child\". If \"no\", captions will have gendered terms. Defaults to \"no\".
    """
...
class ImageAnalysisFeature(Flag):
    ...
    Gender neutral captions can be requested by setting ImageAnalysisOption.gender_neutral_captions to True.
