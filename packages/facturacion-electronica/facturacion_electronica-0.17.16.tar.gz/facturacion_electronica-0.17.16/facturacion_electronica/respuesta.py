    ...
    def DTEs(self, vals):
        ...
        if type(vals) is list:
            for v in vals:
                ...
                emis = v['Encabezado'].get('Emisor', {})
                recep = v['Encabezado'].get('Receptor', {})
                if emis and emis['RUTEmisor'] == self._dte_emisor.RUTEmisor:
                    emis['RUTEmisor'] = recep['RUTRecep']
                    recep['RUTRecep'] = self._dte_emisor.RUTEmisor
                _dtes.append(DOC(v))
        else:
