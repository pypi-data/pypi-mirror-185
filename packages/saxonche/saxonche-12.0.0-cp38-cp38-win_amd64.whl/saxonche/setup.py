...
ext_modules = [Extension(
                       ...
                       libraries=['libs\\win\\saxon-hec-12.0']
                        ),
...
setup(
    name='saxonche',
    version='12.0.0',
    description='A python package for the SaxonC-HE 12.0, an XSLT 3.0, XQuery 3.1, XPath 3.1 and Schema Validator processor by Saxonica.',
