...
def make_transfer_learning_data(h5_list, start_frame, end_frame, equal_x_trial_inds, vid_dir=None, save_dir=None,
                                final_trimmed_h5_name=None, overwrite=False, model_full_file_name=None, smooth_by=5):
    for h5 in make_list(h5_list):
