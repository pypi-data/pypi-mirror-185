...
class CsdcClient():
    ...
    # curl -X GET "http://localhost:8010/api/cutout/b61e72a2151eb69b73248e8e146ef596?hduidx=35&ra=194.1820667&dec=21.6826583&size=40" > ~/chip.fits
    # Get FITS containing chip from one HDU
    def cutout(self, ra, dec, size, md5, hduidx,
        ...
        #return res
        if outfile is None:
            outfile = f'chip_{md5}_{int(ra)}_{int(dec)}.fits'
