...
class Archiver(
    ...
    def __init__(
        ...
        *,
        ...
        :param notification_events: (experimental) S3 events that will trigger a message to the SNS topic. For example "EventType.LIFECYCLE_EXPIRATION" or "EventType.OBJECT_CREATED".
    ...
    def kms_key(self) -> _aws_cdk_aws_kms_ceddda9d.Key:
        '''(experimental) The KMS key used to encrypt the logs and the SNS topic.
...
class ArchiverProperties:
    ...
    def notification_events(
        ...
        '''(experimental) S3 events that will trigger a message to the SNS topic.
