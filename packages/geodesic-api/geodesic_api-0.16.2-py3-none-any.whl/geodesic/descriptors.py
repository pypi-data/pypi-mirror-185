...
class _BaseDescr:
    ...
    def __init__(self, nested: str = None, doc: str = None, default=None, dict_name=None, deprecated=False):
        """
        Args:
    ...
    def __set__(self, obj: object, value: object):
        if self.deprecated:
            warnings.warn(
                f"field {self.public_name} is deprecated and will be removed in a future version", DeprecationWarning)
