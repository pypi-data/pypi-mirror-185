    ...
    **parameters,
    ...
    if split_by_precursors_mz_tol is None or ms_level in (1, None):
        tab = _run_feature_finder_metabo(
            peak_map, ms_level, verbose, run_feature_grouper, **parameters
        )
    ...
    for precursors, sub_peak_map in sorted(
        ...
        peaks = _run_feature_finder_metabo(
            sub_peak_map, ms_level, verbose, run_feature_grouper, **parameters
        )
...
def _run_feature_finder_metabo(
    peak_map, ms_level=None, verbose=True, run_feature_grouper=True, **parameters
):
