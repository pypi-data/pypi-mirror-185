...
class TestUsersDeleteIdentity:
    ...
    def patchypatch(self, users, services):
        with ExitStack() as stack:
            ...
            stack.enter_context(patch("sym.flow.cli.helpers.api_operations.OperationHelper.handle_delete_identities"))
            yield
    ...
    def test_delete_user_identity_does_not_prompt_external_id(self, click_setup, users, services):
        with click_setup() as runner:
