...
class PhotonCamera():
    ...
    def takeOutputSnapshot(self) -> None: 
        ...
        """
    @property
    def _driverModeEntry(self) -> ntcore._ntcore.BooleanPublisher:
        """
...
class PhotonTrackedTarget():
    ...
    def __init__(self) -> None: 
        ...
        """
    @typing.overload
    def __init__(self, yaw: float, pitch: float, area: float, skew: float, fiducialID: int, pose: wpimath.geometry._geometry.Transform3d, alternatePose: wpimath.geometry._geometry.Transform3d, ambiguity: float, corners: typing.List[typing.Tuple[float, float]]) -> None: ...
...
class RobotPoseEstimator():
    ...
    def __init__(self, aprilTags: robotpy_apriltag._apriltag.AprilTagFieldLayout, strategy: PoseStrategy, cameras: typing.List[typing.Tuple[PhotonCamera, wpimath.geometry._geometry.Transform3d]]) -> None: 
        ...
        :param cameras:   An ArrayList of Pairs of PhotonCameras and their respective
                          ...
                          (ie, robot -> camera).
        """
    def getLastPose(self) -> wpimath.geometry._geometry.Pose3d: ...
    ...
    def update(self) -> typing.Tuple[wpimath.geometry._geometry.Pose3d, milliseconds]: 
        """
        Update the estimated pose using the selected strategy.

        :returns: The updated estimated pose and the latency in milliseconds.
        """
    pass
