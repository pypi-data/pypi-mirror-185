...
class ClockParameters(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        tick_period_seconds_numerator: builtins.int = ...,
        tick_period_seconds_denominator: builtins.int = ...,
        epoch_type: typing.Optional[global___EpochType.Enum.ValueType] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_epoch_type",b"_epoch_type"]) -> typing.Optional[typing_extensions.Literal["epoch_type"]]: ...
