...
class BundledUpdateStatus(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        state: global___BundledUpdateState.Enum.ValueType = ...,
        result: typing.Optional[global___BundledUpdateResult.Enum.ValueType] = ...,
        current_state_progress_hundreth_percent: typing.Optional[builtins.int] = ...,
        transfer_id: typing.Optional[builtins.int] = ...,
        bundle_filename: typing.Optional[typing.Text] = ...,
        note: typing.Optional[builtins.bytes] = ...,
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_bundle_filename",b"_bundle_filename"]) -> typing.Optional[typing_extensions.Literal["bundle_filename"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_current_state_progress_hundreth_percent",b"_current_state_progress_hundreth_percent"]) -> typing.Optional[typing_extensions.Literal["current_state_progress_hundreth_percent"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_extended_status",b"_extended_status"]) -> typing.Optional[typing_extensions.Literal["extended_status"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_note",b"_note"]) -> typing.Optional[typing_extensions.Literal["note"]]: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_transfer_id",b"_transfer_id"]) -> typing.Optional[typing_extensions.Literal["transfer_id"]]: ...
