...
def resample(input_raster="", output_raster="" , xres=3.125 , yres=3.125, SavFig=False):
...
def Akhdefo_inversion(horizontal_InSAR="", Vertical_InSAR="", EW_Akhdefo="", NS_Akhdefo="", demFile="", output_folder=r""):
    ...
    DEW_insar=D_EW_InSAR.read(1)
    DEW_akhdefo=D_EW_akhdefo.read(1)
    D_vertical=D_vertical_insar.read(1)
    DNS_akhdefo=D_NS_akhdefo.read(1)
    ...
    trend=plung_degree.tif+"/"+"trend_degrees.tif"
    ...
    # import AkhdefoPlot
    # from AkhdefoPlot import akhdefo_viewer
    ...
    # outputfileName="3D_Disp.jpg", unit=1, alpha=0.8, noDATA_Mask=True)
    ...
    # outputfileName="plunge.jpg", unit=1, alpha=0.8, noDATA_Mask=True)
    ...
    # outputfileName="trend.jpg", unit=1, alpha=0.8, noDATA_Mask=True)
