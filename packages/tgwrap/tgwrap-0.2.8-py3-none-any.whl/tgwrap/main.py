...
class TgWrap():
    ...
    def _run_graph_step(self, command, working_dir, directory, collect_output_file, dry_run):
    ...
    def run_all(self, command, debug, dry_run, no_lock, update_source,
        exclude_external_dependencies, step_by_step, auto_approve, 
